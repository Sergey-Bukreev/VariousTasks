...
import {addMoneyToBudget, createMessage, repairHouse, toFireStaff, toHireStaff} from "./Functiontask";
...
test("Greeting message should be correct for city", ()=> {
    ...
    expect(message).toBe("Hello New York citizens. I want to ba happy. All 1000000 people")
})
